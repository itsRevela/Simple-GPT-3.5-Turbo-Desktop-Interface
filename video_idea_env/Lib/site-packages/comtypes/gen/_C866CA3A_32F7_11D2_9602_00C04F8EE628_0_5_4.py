...
__all__ = [
    'SAFT24kHz16BitMono', 'SPCT_SLEEP', 'DISPID_SRSetPropertyNumber',
    'SpStreamFormatConverter', 'DISPID_SRCEventInterests',
    'SRTEmulated', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SGRsAdd', 'SP_VISEME_21', 'DISPID_SABIEventBias',
    'DISPID_SLWs_NewEnum', 'SSSPTRelativeToStart',
    'DISPID_SRCESoundStart', 'SpeechAddRemoveWord',
    'SAFTGSM610_11kHzMono', 'DISPID_SRCSetAdaptationData',
    'SPBOOKMARKOPTIONS', 'DISPID_SVEStreamStart', 'SVSFIsXML',
    'SPINTERFERENCE_NOISE', 'ISpResourceManager', 'SpVoice',
    'SGDSActiveWithAutoPause', 'DISPID_SPPName', 'SASStop',
    'eLEXTYPE_RESERVED9', 'SPEI_SOUND_END', 'SPEI_RESERVED2',
    'SPRS_ACTIVE', 'SAFT8kHz16BitStereo', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPILanguageId', 'SPVISEMES', 'SPPS_Function',
    '_SPAUDIOSTATE', 'SECNormalConfidence',
    'DISPID_SABufferNotifySize', 'DISPID_SVSCurrentStreamNumber',
    'SAFT48kHz16BitMono', 'SVP_17', 'DISPID_SMSADeviceId',
    'DISPID_SPPsCount', 'SAFTCCITT_uLaw_44kHzStereo', 'SVPOver',
    'SAFT12kHz8BitStereo', 'SVSFNLPMask', 'SVSFDefault',
    'IInternetSecurityMgrSite', 'LONG_PTR',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'ISpeechPhraseReplacements',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SWFEFormatTag',
    'SAFT12kHz16BitMono', 'DISPID_SpeechCustomStream',
    'SPGS_DISABLED', 'SpeechRuleAttributes', 'SPPS_LMA',
    'SAFT12kHz8BitMono', 'DISPID_SRRGetXMLResult', 'SVSFPersistXML',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPFM_NUM_MODES',
    'SAFTADPCM_22kHzStereo', 'SPPS_SuppressWord',
    'DISPID_SpeechLexicon', 'DISPID_SLWType', 'DISPID_SPRuleChildren',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SLPPhoneIds',
    'SpPhoneConverter', 'DISPID_SLPType', 'SPRST_INACTIVE',
    'SPSHT_OTHER', 'SPEI_RESERVED6', 'ISpPhraseAlt', 'SpWaveFormatEx',
    'DISPID_SPRulesItem', 'SREStreamStart', 'DISPID_SRCResume',
    'SPEI_TTS_BOOKMARK', 'ISpVoice', 'SVEPhoneme', 'SPPHRASEPROPERTY',
    'DISPID_SPPFirstElement', 'DISPID_SRGSetTextSelection',
    'DISPID_SVIsUISupported', 'SPLO_DYNAMIC', 'DISPID_SOTCDefault',
    'DISPID_SVEAudioLevel', 'DISPID_SLPLangId', 'DISPID_SRCESoundEnd',
    'SPVOICESTATUS', 'DISPID_SGRSTs_NewEnum', 'SAFT32kHz16BitStereo',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SWFEBitsPerSample',
    'UINT_PTR', 'SECLowConfidence',
    ...
    'DISPID_SGRsCommit', 'SREHypothesis', 'SPPS_NotOverriden',
    ...
    'DISPID_SRCEPhraseStart', 'SpeechVoiceEvents',
    'SpeechDiscardType', 'DISPID_SLPsItem', 'SPVPRI_NORMAL',
    'SPEI_INTERFERENCE', 'DISPID_SpeechAudioStatus',
    'eLEXTYPE_PRIVATE17', 'SPWT_LEXICAL',
    'DISPID_SLGetGenerationChange', 'DISPID_SADefaultFormat',
    'ISpProperties', 'DISPID_SpeechPhraseProperty',
    'DISPID_SOTs_NewEnum', 'SpeechVoiceSkipTypeSentence',
    'SPPS_Unknown', 'SVESentenceBoundary',
    'SpeechCategoryRecognizers', 'DISPID_SOTIsUISupported',
    'ISpeechGrammarRule', 'DISPID_SPIStartTime', 'DISPID_SMSALineId',
    'DISPID_SPEDisplayAttributes', 'DISPID_SRGetFormat',
    'SDA_No_Trailing_Space', 'DISPID_SLGenerationId', 'SPAO_NONE',
    'SASClosed', 'DISPID_SPCLangId', 'SpNotifyTranslator',
    'ISpeechCustomStream', 'SpeechAudioFormatType',
    'SGLexicalNoSpecialChars', 'eLEXTYPE_PRIVATE12', 'SPSModifier',
    'SGRSTTWord', 'DISPID_SDKGetlongValue',
    'DISPID_SpeechPhraseAlternates', 'SPRULESTATE',
    'SAFT32kHz8BitStereo', 'DISPID_SGRsCount', 'SPCT_SUB_COMMAND',
    'SRESoundEnd', 'eLEXTYPE_PRIVATE19', 'ISpeechLexicon',
    'SPPS_RESERVED2', 'SSSPTRelativeToCurrentPosition',
    'SpeechGrammarTagWildcard', 'SP_VISEME_12', 'ISpNotifySource',
    'SSTTDictation', 'DISPID_SRGState', 'ISpObjectToken',
    'SWPUnknownWordUnpronounceable', 'DISPID_SRGRecoContext',
    'DISPID_SVGetProfiles', 'DISPID_SOTCId', 'SPRECOCONTEXTSTATUS',
    'DISPID_SAFType', 'SGRSTTRule', 'SpMMAudioEnum', 'SP_VISEME_5',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRCState',
    'DISPID_SRCERecognition', 'SAFTExtendedAudioFormat',
    'SPEI_SOUND_START', 'SpObjectTokenCategory', 'DISPID_SPRsItem',
    'DISPID_SASState', 'DISPID_SGRsItem', 'SpMMAudioOut',
    'SPFM_CREATE_ALWAYS', 'DISPID_SPAPhraseInfo',
    'DISPID_SRCEAdaptation', 'DISPID_SPEActualConfidence',
    'SpeechAudioProperties', 'DISPID_SPIProperties',
    'DISPID_SVEVoiceChange', 'DISPID_SRCreateRecoContext',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SVRate',
    'ISpeechPhraseElements', 'DISPID_SDKSetStringValue',
    '_ISpeechVoiceEvents', 'DISPID_SGRInitialState', 'SPSHT_EMAIL',
    'SINoise', 'DISPID_SASCurrentSeekPosition', 'DISPID_SOTCSetId',
    'eLEXTYPE_PRIVATE14', 'DISPID_SLPSymbolic', 'ISpStreamFormat',
    'SAFTCCITT_ALaw_8kHzMono', 'SGDSActiveUserDelimited',
    'SAFT16kHz8BitStereo', 'SAFTADPCM_8kHzMono', 'SPEI_VISEME',
    'DISPID_SGRSAddWordTransition', 'eLEXTYPE_PRIVATE18',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SGRSTType',
    'DISPID_SGRSTsItem', 'DISPID_SPERetainedSizeBytes', 'SVP_15',
    'DISPID_SpeechAudio', 'STCRemoteServer',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SRTExtendableParse', 'SASRun',
    'ISpeechFileStream', 'DISPID_SVSLastStreamNumberQueued',
    'SpeechVoiceSpeakFlags', 'DISPID_SGRAttributes',
    'DISPID_SDKDeleteValue', 'DISPID_SLWsCount',
    'SpeechBookmarkOptions', 'DISPID_SGRsCommitAndSave',
    'SPINTERFERENCE_TOOFAST', 'tagSTATSTG',
    'DISPID_SVSInputWordPosition', 'DISPID_SPEDisplayText',
    'SVEAudioLevel', 'DISPID_SVEEnginePrivate', 'ISpeechPhraseInfo',
    'SAFTGSM610_44kHzMono', 'SpeechEngineProperties',
    'SpeechRecoProfileProperties', 'ISpEventSource',
    'DISPID_SDKOpenKey', 'SPPS_RESERVED3', 'ISpeechResourceLoader',
    'DISPID_SRAudioInput', 'SPEI_RECOGNITION', 'SVEWordBoundary',
    'SRERecoOtherContext', 'ISpPhoneticAlphabetConverter',
    'DISPID_SPPValue', 'eLEXTYPE_VENDORLEXICON', 'SP_VISEME_18',
    'eLEXTYPE_PRIVATE13', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SPCIdToPhone', 'DISPID_SLWWord', 'SGSDisabled',
    'DISPID_SRCRetainedAudio', 'DISPID_SPEPronunciation',
    'SP_VISEME_7', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SVEViseme',
    ...
    'ISpeechTextSelectionInformation', 'SBONone', 'SRAONone',
    'DISPID_SWFEChannels', 'SVP_8', 'SpeechRecognizerState',
    'DISPID_SDKCreateKey', 'SVP_1', 'ISpEventSink', 'ISpeechDataKey',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPEI_VOICE_CHANGE',
    'DISPID_SABIMinNotification', 'DISPID_SCSBaseStream',
    'SPEI_WORD_BOUNDARY', 'SRTSMLTimeout', 'ISpNotifyTranslator',
    'ISpeechPhraseElement', 'DISPID_SOTSetId', 'ISpeechObjectToken',
    'ISpeechPhraseProperty', 'DISPID_SGRSTPropertyValue',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT11kHz8BitMono', 'SPEI_MIN_TTS', 'SREStreamEnd',
    'ISpeechLexiconPronunciation', 'SpUnCompressedLexicon',
    'SAFT44kHz8BitMono', 'ISpeechObjectTokens',
    'DISPIDSPTSI_SelectionLength', 'ISpRecoCategory', 'SVSFIsNotXML',
    'SRCS_Disabled', 'SPGS_EXCLUSIVE',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SAStatus',
    'SPEI_MAX_SR', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPPS_Verb',
    'DISPID_SPPChildren', 'SVP_13', 'SAFT8kHz8BitMono',
    ...
    'SECFIgnoreWidth', 'SVP_21', 'SSFMCreateForWrite',
    'DISPID_SASFreeBufferSpace', 'SPWORD', 'SpeechEngineConfidence',
    'SRSActiveAlways', 'DISPID_SASCurrentDevicePosition',
    'SP_VISEME_16', 'ISpeechRecoContext',
    'DISPID_SRGetPropertyNumber', 'IInternetSecurityManager',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SVSFlagsAsync',
    'SPAO_RETAIN_AUDIO', 'eLEXTYPE_USER_SHORTCUT', 'SRTAutopause',
    'SVP_18', 'SSTTWildcard', 'SpeechCategoryRecoProfiles',
    'ISpRecognizer2', 'SP_VISEME_20', 'DISPID_SRSSupportedLanguages',
    'DISPID_SRCEAudioLevel', 'SAFTCCITT_uLaw_22kHzStereo',
    'SGRSTTWildcard', 'DISPID_SVResume', 'SREInterference',
    'DISPID_SVEPhoneme', 'SAFT24kHz8BitStereo', 'DISPID_SRRTLength',
    'SPLOADOPTIONS', 'SpObjectToken', 'DISPID_SRSAudioStatus',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRGDictationUnload',
    'DISPID_SBSRead', 'DISPID_SAVolume', 'ISpeechPhraseRules',
    'SECFNoSpecialChars', 'SPAR_Low', 'DISPID_SVEWord',
    'SpeechRecoContextState', 'SDKLLocalMachine', 'SPEI_SR_PRIVATE',
    'SRTReSent', 'SVP_3', 'SPVPRIORITY', 'DISPID_SPIElements',
    'SDKLDefaultLocation', 'SREPropertyNumChange',
    'DISPID_SVDisplayUI', 'ISpeechLexiconWords',
    'SPPHRASEREPLACEMENT', 'DISPID_SRGDictationLoad', 'SP_VISEME_19',
    'DISPID_SLAddPronunciation', 'SP_VISEME_8', 'DISPID_SRGCommit',
    'SpeechTokenIdUserLexicon', 'SAFTCCITT_uLaw_8kHzMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SpeechTokenKeyFiles',
    'SPEI_MIN_SR', 'ISpDataKey', 'DISPID_SRRRecoContext',
    'SpeechEmulationCompareFlags', 'SPAUDIOSTATE',
    ...
    'SSFMCreate', 'SPEI_SR_BOOKMARK', 'SRSInactive',
    'SpeechStreamFileMode', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPEsItem',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SGRSTransitions',
    'SpeechRecoEvents', 'SPINTERFERENCE_TOOSLOW', 'SPCT_COMMAND',
    'SPRULE', 'DISPID_SpeechAudioFormat', 'DISPID_SLWsItem',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPIGetText',
    'eLEXTYPE_PRIVATE1', 'SDKLCurrentUser',
    'DISPID_SRSCurrentStreamPosition', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SRRGetXMLErrorInfo', 'SVF_Stressed',
    'DISPID_SRGCmdLoadFromFile', 'SPSERIALIZEDRESULT',
    'SPPROPERTYINFO', 'DISPID_SPRulesCount', 'SAFT22kHz16BitStereo',
    'DISPID_SRCBookmark', 'eLEXTYPE_PRIVATE3',
    ...
    'SLOStatic', 'SPSVerb', 'SLODynamic', 'SVP_16',
    'SDA_One_Trailing_Space', 'DISPID_SPIAudioSizeTime',
    'SVEStartInputStream', 'DISPID_SOTDataKey', 'SVP_14',
    'DISPID_SLGetPronunciations', 'SVSFVoiceMask',
    'SAFT48kHz8BitMono', 'SVP_12', 'SVSFPurgeBeforeSpeak',
    'DISPID_SLGetWords', 'SPPHRASEELEMENT',
    'DISPID_SRCRetainedAudioFormat', 'SREAdaptation',
    'SpNullPhoneConverter', 'ISpeechXMLRecoResult',
    'DISPID_SLWLangId', 'DISPID_SRCEEnginePrivate',
    'DISPID_SPPEngineConfidence', 'DISPID_SPRs_NewEnum',
    'SPPHRASERULE', 'SGDSActive', 'DISPID_SRRTStreamTime',
    'DISPID_SASNonBlockingIO', 'SpeechTokenValueCLSID',
    'DISPID_SRCRequestedUIType', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SpeechAudioBufferInfo', 'SPEI_TTS_PRIVATE', 'DISPIDSPTSI',
    'DISPID_SPISaveToMemory', 'IEnumString', 'DISPID_SPIEngineId',
    'SPEI_RESERVED5', 'SFTSREngine', 'ISpRecoGrammar2', 'SGLexical',
    'STSF_AppData', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SLPsCount', 'DISPID_SGRSRule',
    'ISpPhoneticAlphabetSelection', 'tagSPPROPERTYINFO',
    'DISPID_SpeechObjectTokens', 'DISPID_SRDisplayUI',
    'ISpeechMemoryStream', 'SP_VISEME_9', 'SAFTADPCM_22kHzMono',
    'SRSInactiveWithPurge', 'DISPID_SDKEnumKeys', 'SP_VISEME_17',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPINTERFERENCE_LATENCY_WARNING',
    'eLEXTYPE_RESERVED7', 'DISPID_SGRSTText', 'SRAImport',
    'ISpRecognizer3', 'tagSPTEXTSELECTIONINFO',
    ...
    'ISpeechGrammarRules', 'SpCustomStream',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPDATAKEYLOCATION',
    'SPDKL_CurrentConfig', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRSetPropertyString', 'SPDKL_LocalMachine',
    'SAFTGSM610_8kHzMono', 'DISPID_SOTGetAttribute',
    'DISPID_SREmulateRecognition', 'SREAllEvents',
    'ISpeechRecoResultTimes', 'SPFM_OPEN_READONLY',
    'SDA_Two_Trailing_Spaces', 'SITooFast', 'SPSERIALIZEDPHRASE',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SVSLastBookmarkId',
    'DISPID_SPPParent', 'SPXRO_SML', 'SAFTADPCM_44kHzStereo',
    'DISPID_SPIGrammarId', 'SVP_5', 'DISPID_SGRs_NewEnum',
    'ISpeechAudioStatus', 'ISpeechAudioBufferInfo',
    'SAFT22kHz8BitMono', 'eLEXTYPE_PRIVATE15', 'SITooLoud',
    'DISPID_SRRSetTextFeedback', 'ISpeechGrammarRuleState',
    'SDKLCurrentConfig', 'DISPID_SRCEEndStream',
    'DISPID_SLWPronunciations', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SpSharedRecognizer',
    'DISPID_SPAs_NewEnum', 'SDTAudio', 'SpPhraseInfoBuilder',
    'SRAInterpreter', 'SRADefaultToActive', 'DISPID_SVSVisemeId',
    'SPSLMA', 'SpeechPropertyLowConfidenceThreshold', 'DISPIDSPRG',
    'SAFT11kHz8BitStereo', 'SpeechCategoryAudioOut', 'DISPID_SFSOpen',
    'DISPID_SRSNumberOfActiveRules', 'SPEI_SR_AUDIO_LEVEL',
    'SpeechRecognitionType', 'DISPID_SPIAudioStreamPosition',
    'SAFT22kHz16BitMono', 'SDTDisplayText', 'SAFT48kHz8BitStereo',
    'SPEI_RESERVED1', 'ISpeechWaveFormatEx', 'SAFT48kHz16BitStereo',
    'SpeechDictationTopicSpelling', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SPRuleConfidence',
    'ISpLexicon', 'SPEI_ADAPTATION', 'DISPID_SPEEngineConfidence',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SPEAudioSizeTime',
    'SRERequestUI', 'SRTStandard', 'DISPID_SVStatus',
    'SAFT44kHz16BitStereo', 'SPINTERFERENCE', 'SPLEXICONTYPE',
    'DISPID_SpeechVoiceStatus', 'ISpeechPhraseAlternates',
    'SP_VISEME_2', 'SAFTNoAssignedFormat', 'ISpeechAudioFormat',
    'SVSFNLPSpeakPunc', 'SPPS_Noncontent', 'SVP_2',
    'SpeechVisemeType', 'SFTInput', 'DISPID_SOTGetDescription',
    'SPPS_RESERVED4', 'eLEXTYPE_RESERVED10', 'ISpeechPhraseRule',
    'ISpRecoResult', 'SVSFParseMask', 'DISPID_SOTCategory',
    ...
    'SREBookmark', 'DISPID_SOTId', 'SPAR_Medium', 'ISpShortcut',
    'DISPID_SRRAudio', 'SPEI_PHONEME', 'DISPID_SpeechMMSysAudio',
    'SpResourceManager', 'SpFileStream', 'ISpRecoGrammar',
    'SVEPrivate', 'SDTReplacement', 'DISPID_SLPs_NewEnum', 'SVP_0',
    'DISPID_SRGCmdSetRuleIdState', 'STCLocalServer',
    'SAFTNonStandardFormat', 'ISpeechPhraseInfoBuilder',
    'SPRECOSTATE', 'SSFMOpenForRead', 'DISPID_SpeechDataKey',
    'DISPID_SPELexicalForm', 'SPPARTOFSPEECH', 'SBOPause',
    'SpeechTokenKeyUI', 'DISPIDSPTSI_ActiveOffset', 'SPWORDLIST',
    'DISPID_SVSpeakStream', 'DISPID_SGRSTRule', 'DISPID_SPPs_NewEnum',
    'SAFTADPCM_11kHzMono', 'SpeechRetainedAudioOptions',
    'DISPID_SVPause', 'SPEI_PHRASE_START', 'DISPID_SRCVoice',
    'SECFIgnoreKanaType', 'DISPID_SpeechObjectToken',
    'SPADAPTATIONRELEVANCE', 'SRAORetainAudio', 'SpeechGrammarState',
    'ISpStreamFormatConverter', 'DISPID_SRRecognizer',
    'SPBINARYGRAMMAR', 'SpShortcut', 'SPEVENTSOURCEINFO',
    'ISpRecognizer', 'DISPID_SDKEnumValues',
    ...
    'SPRST_ACTIVE_ALWAYS', 'eLEXTYPE_MORPHOLOGY',
    'SAFT32kHz16BitMono', 'SAFTCCITT_uLaw_11kHzMono',
    'ISpeechBaseStream', 'DISPID_SPAsCount', 'ISpPhoneConverter',
    'SpeechWordPronounceable', 'DISPID_SWFEExtraData',
    'SpInProcRecoContext', 'DISPID_SVVoice', 'SPSEMANTICFORMAT',
    'SpeechVoicePriority', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SLPPartOfSpeech', 'DISPID_SpeechRecoResult2',
    'SpeechMicTraining', 'eLEXTYPE_RESERVED8',
    'DISPID_SRAudioInputStream', 'SPFM_OPEN_READWRITE',
    ...
    'SPVPRI_OVER', 'SPGS_ENABLED', 'SSTTTextBuffer', 'SINoSignal',
    'ISequentialStream', 'SPAUDIOBUFFERINFO', 'SDTRule',
    'DISPID_SRStatus', 'DISPID_SRGReset', 'DISPID_SPRText',
    'DISPID_SPRuleName', 'SpeechCategoryPhoneConverters',
    'DISPID_SRCEPropertyNumberChange', 'SPAS_RUN',
    'SAFTADPCM_11kHzStereo', 'SGDisplay', 'SVPNormal',
    'STSF_FlagCreate', 'SSSPTRelativeToEnd', 'SPSMF_UPS',
    'SpAudioFormat', 'SPFM_CREATE', 'DISPID_SRCERequestUI',
    'DISPID_SpeechVoiceEvent', 'DISPID_SRGDictationSetState',
    'SECFDefault', 'DISPID_SGRAddState', '_ISpeechRecoContextEvents',
    'SAFT44kHz16BitMono', 'DISPID_SFSClose', 'ISpStream', 'SASPause',
    ...
    'DISPID_SWFEAvgBytesPerSec', 'WAVEFORMATEX', 'SGSEnabled',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRGetPropertyString',
    'ISpeechLexiconWord', 'SPAS_PAUSE', 'SAFTCCITT_ALaw_22kHzMono',
    ...
    'SPAR_High', 'SPEI_UNDEFINED', 'SAFT16kHz16BitMono',
    'SP_VISEME_15', 'DISPID_SRState', 'ISpeechObjectTokenCategory',
    'eLEXTYPE_APP', 'SpeechWordType', 'SAFT24kHz16BitStereo',
    'SVSFUnusedFlags', 'SVEEndInputStream', 'SRADynamic',
    'SVSFParseAutodetect', 'SDTPronunciation', 'SpeechRunState',
    'DISPID_SVSRunningState', 'SP_VISEME_13', 'SAFT16kHz16BitStereo',
    'SPWORDPRONUNCIATIONLIST', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SPERetainedStreamOffset', 'SVP_9',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SpeechLexiconWord',
    'DISPID_SpeechGrammarRuleState', 'SPEI_RECO_STATE_CHANGE',
    'SpLexicon', 'SpeechDisplayAttributes',
    'DISPID_SGRSTPropertyName', 'SVP_20', 'SPXMLRESULTOPTIONS',
    'SpeechGrammarTagDictation', 'eLEXTYPE_PRIVATE16', 'SVP_6',
    'DISPID_SOTDisplayUI', 'SP_VISEME_10', 'SPWAVEFORMATTYPE',
    'DISPID_SRCCmdMaxAlternates', 'SVSFParseSsml',
    'DISPID_SRCCreateGrammar', 'SECFEmulateResult',
    'SAFT22kHz8BitStereo', 'SpeechLexiconType', 'SPCONTEXTSTATE',
    'DISPID_SpeechRecoContext', 'DISPID_SVAlertBoundary',
    'DISPID_SpeechRecognizer', 'DISPID_SOTCEnumerateTokens',
    'eLEXTYPE_PRIVATE4', 'SITooSlow', 'SpPhoneticAlphabetConverter',
    'DISPID_SRCEBookmark', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRRPhraseInfo', 'SpSharedRecoContext', 'SPPHRASE',
    'SRESoundStart', 'DISPID_SWFESamplesPerSec',
    'DISPID_SVEventInterests', 'SPPS_Noun', 'DISPID_SRGRules',
    'ISpObjectWithToken', 'SPEI_REQUEST_UI',
    ...
    'DISPID_SVGetAudioOutputs', 'SPSSuppressWord', 'ISpMMSysAudio',
    'SPSEMANTICERRORINFO', 'ISpRecoContext', '__MIDL_IWinTypes_0009',
    'SPWT_DISPLAY', 'SAFTGSM610_22kHzMono',
    'DISPID_SpeechPhraseBuilder', 'SPEI_MAX_TTS', 'SPSHT_Unknown',
    'SPEI_RESERVED3', 'DISPID_SPIAudioSizeBytes', 'DISPID_SPAsItem',
    'SPPS_Interjection', 'DISPID_SOTRemoveStorageFileName',
    'ISpeechPhraseProperties', 'ISpNotifySink', 'SGRSTTTextBuffer',
    'ISpXMLRecoResult', 'SpeechAudioFormatGUIDText',
    'SAFT24kHz8BitMono', 'SPSHT_NotOverriden', 'SPRECOGNIZERSTATUS',
    'ISpeechRecoResult', 'SAFT8kHz16BitMono', 'DISPID_SPEsCount',
    'SPWORDPRONUNCIATION', 'ISpeechRecoResultDispatch',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPAS_CLOSED',
    'SP_VISEME_11', 'DISPID_SDKDeleteKey', 'DISPID_SDKSetBinaryValue',
    'DISPID_SVSkip', 'SVP_7', 'DISPID_SPRNumberOfElements',
    'Speech_StreamPos_RealTime', 'STCInprocHandler', 'ISpeechAudio',
    'SP_VISEME_3', 'SPSFunction', 'SGSExclusive', 'SECHighConfidence',
    'SpeechLoadOption', 'SPSInterjection', 'ISpAudio',
    'SAFT44kHz8BitStereo', 'SINone', 'ISpRecoContext2',
    'DISPID_SGRClear', 'DISPID_SPRDisplayAttributes',
    'SAFTTrueSpeech_8kHz1BitMono', 'IStream', 'DISPID_SpeechVoice',
    'SVF_None', 'SPCT_SUB_DICTATION', 'SVP_10',
    'DISPID_SGRSTNextState', 'DISPID_SABIBufferSize',
    ...
    'DISPID_SMSSetData', 'SREFalseRecognition',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SpeechLexiconProns',
    'SAFTADPCM_8kHzStereo', 'SREPrivate', 'SPCS_DISABLED', 'SDTAll',
    'SpeechAllElements', 'ISpeechPhraseReplacement',
    'eLEXTYPE_PRIVATE6', 'SPEI_HYPOTHESIS',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SPPId',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpeechCategoryAudioIn',
    'DISPID_SVEBookmark', 'SPBO_NONE', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRCEStartStream', 'SVPAlert', 'DISPID_SRIsUISupported',
    'DISPID_SGRSTWeight', 'SP_VISEME_0', 'SP_VISEME_1',
    'SPAUDIOOPTIONS', 'SREAudioLevel', 'DISPID_SMSGetData',
    'SPEI_END_INPUT_STREAM', 'DISPID_SPPConfidence',
    'SpeechFormatType', 'SRSEDone', 'SPCATEGORYTYPE',
    'DISPID_SOTRemove', 'SITooQuiet', 'DISPID_SOTCGetDataKey',
    'DISPID_SPACommit', 'SDTAlternates', 'SREPhraseStart',
    'SREStateChange', 'DISPID_SABufferInfo',
    'DISPID_SRRTOffsetFromStart', 'SPRST_ACTIVE', 'SPWF_INPUT',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SpeechMemoryStream',
    'SPEI_END_SR_STREAM', 'DISPID_SRRAudioFormat',
    'DISPID_SpeechGrammarRule', 'DISPID_SRRSpeakAudio',
    'IEnumSpObjectTokens', 'SDTLexicalForm', 'Speech_StreamPos_Asap',
    'eLEXTYPE_RESERVED4', 'SPAS_STOP', 'SpeechStreamSeekPositionType',
    ...
    'SpeechVisemeFeature', 'SPTEXTSELECTIONINFO', 'SPLO_STATIC',
    'SpCompressedLexicon', 'SP_VISEME_6', 'DISPID_SVAudioOutput',
    'SPRST_NUM_STATES', 'STSF_LocalAppData', 'SPRS_INACTIVE',
    'DISPID_SpeechPhraseRules', 'SRSActive',
    'DISPID_SRCEFalseRecognition', 'SpeechDataKeyLocation',
    'SAFTDefault', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SGRsDynamic', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SPIEnginePrivateData', 'DISPID_SVSPhonemeId', 'SVP_4',
    'SP_VISEME_14', 'DISPID_SPRuleParent', 'SPSHORTCUTTYPE',
    'DISPID_SASetState', 'SWPKnownWordPronounceable',
    'SGPronounciation', 'STSF_CommonAppData', 'SVP_11',
    'DISPID_SVSLastBookmark', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SRGCmdSetRuleState', 'SAFT16kHz8BitMono',
    'DISPID_SPRsCount', 'SGRSTTEpsilon', 'SAFT32kHz8BitMono',
    'SPAUDIOSTATUS', 'SWTAdded', 'DISPID_SWFEBlockAlign',
    'eLEXTYPE_PRIVATE20', 'SVEAllEvents', 'SVSFParseSapi',
    'DISPID_SDKSetLongValue', 'DISPID_SGRSTsCount',
    'DISPID_SRRDiscardResultInfo', 'SPPS_RESERVED1',
    'ISpeechVoiceStatus', 'STCInprocServer', 'ISpeechVoice',
    'SpeechAudioFormatGUIDWave', 'DISPID_SVGetAudioInputs',
    'DISPID_SPRules_NewEnum', 'SAFT11kHz16BitMono',
    'ISpGrammarBuilder', 'SPEI_RECO_OTHER_CONTEXT', 'SWTDeleted',
    'SLTUser', 'DISPID_SRCERecognizerStateChange', 'DISPID_SGRId',
    'DISPID_SPIRule', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SVWaitUntilDone', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SDKGetBinaryValue', 'SPSHORTCUTPAIRLIST',
    'SpeechUserTraining', 'DISPID_SpeechPhraseRule', 'SRATopLevel',
    'SPSNotOverriden', 'SpMMAudioIn', 'SLTApp', 'eLEXTYPE_USER',
    'SVSFIsFilename', 'SGDSInactive', 'ISpSerializeState',
    'SGRSTTDictation', 'DISPID_SPPsItem',
    ...
    'SPSTREAMFORMATTYPE', 'eWORDTYPE_DELETED', 'DISPID_SPEs_NewEnum',
    '_RemotableHandle', 'SPRECORESULTTIMES', 'DISPID_SRGId',
    'SpStream', 'DISPID_SGRAddResource', 'SRERecognition',
    'DISPID_SVSpeak', 'SPBO_PAUSE', 'DISPID_SVAudioOutputStream',
    'ISpPhrase', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SGRSTPropertyId', 'SPVPRI_ALERT', 'eLEXTYPE_PRIVATE11',
    'ISpeechRecoResult2', 'eLEXTYPE_PRIVATE2', 'SPBO_AHEAD',
    'SpeechCategoryAppLexicons', 'SAFT8kHz8BitStereo',
    'DISPID_SRProfile', 'SAFT12kHz16BitStereo', 'SpeechAudioVolume',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SOTGetStorageFileName',
    'ISpeechGrammarRuleStateTransitions', 'SpeechRegistryUserRoot',
    'DISPID_SpeechRecognizerStatus',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SP_VISEME_4',
    'SPINTERFERENCE_NONE', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPWF_SRENGINE', 'SVEVoiceChange', 'SpeechAudioState',
    'DISPID_SRRAlternates', 'Speech_Max_Pron_Length',
    'SAFTADPCM_44kHzMono', 'SPCS_ENABLED', 'SpMemoryStream',
    'SVEBookmark', 'DISPID_SpeechLexiconWords',
    'SPEI_START_SR_STREAM', 'SPEI_SR_RETAINEDAUDIO', 'SPAR_Unknown',
    'DISPID_SGRsFindRule', 'SDTProperty', 'SPXRO_Alternates_SML',
    'ISpeechRecoGrammar', 'SPBO_TIME_UNITS',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SOTsItem',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SOTsCount',
    'DISPID_SRRSaveToMemory', 'eWORDTYPE_ADDED', 'SPEVENT',
    'DISPID_SPRFirstElement', 'DISPID_SpeechGrammarRules',
    'SPGRAMMARSTATE', 'ISpeechGrammarRuleStateTransition', 'SPSNoun',
    'DISPID_SRCPause', 'SpeechInterference', 'DISPID_SRCRecognizer',
    'DISPID_SpeechGrammarRuleStateTransition', 'SRAExport',
    'SVEViseme', 'SAFTText', 'SpeechGrammarWordType', 'SPEVENTENUM',
    'STCAll', 'DISPID_SRIsShared', 'DISPID_SRRTimes', 'SVP_19',
    'SPFILEMODE', 'SPPS_Modifier', 'DISPID_SBSSeek',
